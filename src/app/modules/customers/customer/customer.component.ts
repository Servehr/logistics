...
export class CustomerComponent {
    ...
    @Input() Header: any[] = [
      {
        "order": [        
          { Header: 'Firstname', Column: 'merchant', show: true }, 
          { Header: 'Surname', Column: 'products', show: true  }, 
          { Header: 'Phone Number', Column: 'tag', show: true  }, 
          { Header: 'Email', Column: 'customers', show: true  },
          { Header: 'State', Column: 'phone', show: true  }, 
          { Header: 'Address', Column: 'orders', show: true  }, 
    ...
    @Input() RowAndColumn: any[] = [
      {
        orders: [                
            { merchant: 'Dangote PLC', tag: 'ERIDUEJR', products: 'Laptop', customers: 'Uzochukwu Emeka', phone: '080973764764', orders: '5,000', actions: ''},
            { merchant: 'Ebano Supermarket', tag: 'FKFIEMCD',  products: 'School Bag', customers: 'Nnamadi Azikwe', phone: '07075747333', orders: '3,500', actions: ''},
            { merchant: 'Unilever PLC', tag: 'MCNVBRLA',  products: 'Patek Wrist Watch', customers: 'Donaltus Benjamin', phone: '08023384222', orders: '716', actions: ''},
            { merchant: 'Emmanuchukwu Uzochukwu & Son', tag: 'QP987CXS',  products: 'Nike Sandal', customers: 'Oluwapelumi Oluwatosin', phone: '09087439823', orders: '120', actions: ''}
        ],
        products: [                
    ...
    @Input() ActionName: string = 'customers'
