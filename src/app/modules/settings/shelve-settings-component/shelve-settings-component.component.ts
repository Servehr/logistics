...
@Component({
  selector: 'app-shelve-settings-component',
  templateUrl: './shelve-settings-component.component.html',
  styleUrls: ['./shelve-settings-component.component.css']
})
export class ShelveSettingsComponentComponent {
